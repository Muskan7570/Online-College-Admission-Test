...
<div class="wrapper wrapper-content">
    ...
    ?>
					...
					<div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                              <h5><span class="label label-info pull-right">Date Registered</span></h5>
                            </div>
                            <div class="ibox-content">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                              <h5><span class="label label-primary pull-right">Previous Years Questions</span></h5>	  
                            </div>
                            <div class="ibox-content">
                                <h3><a href="../assets/docs/PreviousYear.pdf" target="_blank">Question Paper</a></h3>
						    </div>
                        </div>
                    </div>
