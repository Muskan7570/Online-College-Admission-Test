...
<div class="col-lg-6">
<span class="logo">
  <a href="../index.php"><img src="image/primarylogo.png" style="height: 65px"></a>
</span></div>
<?php
...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="dash.php?q=1" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=index.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}?>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dash.php?q=1">User Details</a></li>
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Father Name</b></td><td><b>Gender</b></td><td><b>school</b></td><td><b>Percentage</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
  $fname=$row['fname']; 
  ...
  $email = $row['email'];
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$fname.'</td><td>'.$gender.'</td><td>'.$school.'</td><td>'.$percentage.'</td><td>'.$email.'</td><td>'.$mob.'</td>
